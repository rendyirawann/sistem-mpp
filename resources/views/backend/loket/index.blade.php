            ...
            <div class="card-header border-bottom border-gray-300">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none me-3"
                        ...
                        <button type="button" class="btn btn-sm btn-danger" data-kt-loket-table-select="delete_selected">
                            <i class="ki-outline ki-trash  me-2"></i>Delete
                            Selected</button>
                    </div>
                    <!--end::Group actions-->
                    <!--begin::Toolbar-->
                    ...
                    <form method="post" id="FormTambahModalID" class="form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_loket_scroll"
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label for="prefix"
                                    class="required fw-semibold fs-6 mb-2 text-left d-block">Prefix</label>
                                <!--end::Label-->
                                <!--begin::Input-->
        ...
        <script>
            ...
            $('#SubmitDeleteRowForm').on('click', function() {
                ...
                $.ajax({
                    ...
                    type: 'DELETE',
                    // GANTI BAGIAN 'data' MENJADI 'headers'
                    headers: {
                    ...
                    error: function(xhr) {
                        ...
                        let msg = xhr.responseJSON?.message || xhr.responseText || 'Gagal menghapus data';

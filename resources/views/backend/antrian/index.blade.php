...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="row g-5 mb-7">
        @php
        $cards = [
            ['id'=>'jumlah-antrian','label'=>'Jumlah Antrian','icon'=>'ki-user-tick','color'=>'warning'],
            ['id'=>'antrian-sekarang','label'=>'Antrian Sekarang','icon'=>'ki-profile-circle','color'=>'success'],
            ['id'=>'antrian-selanjutnya','label'=>'Antrian Selanjutnya','icon'=>'ki-people','color'=>'info'],
    ...
    <div class="card border border-gray-300 shadow-sm">
        ...
        <div class="card-body py-4 position-relative">
            <div id="loket-loading" class="position-absolute top-50 start-50 translate-middle d-none text-center z-index-3">
...
$(document).ready(function () {
    ...
    table = $('#tabel-antrian').DataTable({
        ...
        columns: [
            ...
            { data: 'nama_loket', className:'text-center' },
            {
                data: null,

...
Route::middleware('auth')->group(function () {
    ...
    Route::get('get-antrian', [AntrianController::class, 'getAntrian'])->name('antrian.get');
    ...
    Route::post('/loket/aktifkan', [LoketController::class, 'aktifkan'])->name('loket.aktifkan');
    Route::post('/loket/nonaktifkan', [LoketController::class, 'nonaktifkan'])->name('loket.nonaktifkan');
    Route::get('/loket/jumlah', [LoketController::class, 'jumlah'])->name('loket.jumlah');
    Route::get('/loket/aktif', [LoketController::class, 'aktif'])->name('loket.aktif');
    Route::get('/loket/nonaktif', [LoketController::class, 'nonaktif'])->name('loket.nonaktif');
...
// ==============================
// KIOS ANTRIAN (TANPA AUTH)
// ==============================

// Halaman utama kios
Route::get('/', [FrontController::class, 'index'])->name('home');

// Proses ambil antrian (AUTO PRINT di Controller)

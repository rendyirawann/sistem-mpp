                ...
                ->addColumn('action', function($row) {
                    ...
                    if (auth()->user()->can('user.show') || auth()->user()->can('user.edit') || auth()->user()->can('user.delete')) {
                        ...
                        $x.='<div class="dropdown text-end">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark fs-6" aria-labelledby="dropdownMenuButton2">';
                        ...
                        if (auth()->user()->can('user.edit')) {
                            ...
                            // Jika user sedang dibanned → tampilkan unban
                            if ($row->isBanned()) {
                                $x .= '
                                <li>
                                    <a class="dropdown-item px-3 text-success" href="javascript:void(0)"
                                ...
                                $x .= '
                                <li>
                                    <a class="dropdown-item px-3 text-danger" href="javascript:void(0)"
...
->addColumn('status', function($row) {
    ...
    public function show($id): View
    {
        ...
        return view('backend.user_management.user.show', compact('data'));
    }
